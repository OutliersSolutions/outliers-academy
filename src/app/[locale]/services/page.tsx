...
export default async function ServicesPage({
  ...
  const services = [
    {
      title: tAbout('services.webMarketing'),
      description: tAbout('services.webMarketingDesc'),
      tags: t.raw('webMarketing.tags') as string[],
      icon: "📢",
      link: `/${params.locale}/services/marketing`
    },
    {
      title: tAbout('services.customSystems'),
      description: tAbout('services.customSystemsDesc'),
      tags: t.raw('customSystems.tags') as string[],
      icon: "🖥️",
      link: `/${params.locale}/services/systems`
    },
    {
      title: tAbout('services.aiAutomation'),
      description: tAbout('services.aiAutomationDesc'),
      tags: t.raw('aiAutomation.tags') as string[],
      icon: "🤖",
      link: `/${params.locale}/services/ai-agents`
    }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className="group">
                <Link href={service.link as Route}>
                  <div className="bg-white border border-neutral-200 rounded-2xl p-8 h-full hover:shadow-xl hover:border-primary/20 transition-all duration-300 group-hover:-translate-y-2 cursor-pointer">
