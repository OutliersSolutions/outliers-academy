          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <nav className="hidden lg:flex items-center space-x-2 text-sm text-gray-500">
                ...
                <ChevronRight className="h-4 w-4" />
                <Link href={`/${locale}/course/${params.slug}/overview`} className="hover:text-gray-700">
                  {course.name}
                </Link>
                <ChevronRight className="h-4 w-4" />
                <span className="text-gray-900 dark:text-gray-100 font-medium">
                  {isSpanish ? 'Lecciones' : 'Lessons'}
                </span>
              </nav>
            </div>
                  ...
                  {currentLesson.is_preview || course.is_enrolled ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                      <div className="text-center text-white">
                        ...
                        <Button onClick={() => router.push(`/${locale}/course/${params.slug}/overview`)}>
                          {isSpanish ? 'Ver detalles del curso' : 'View course details'}
                        </Button>
                      </div>
                    </div>
                  )}
