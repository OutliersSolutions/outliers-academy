...
export function WhatsAppButton({ 
  ...
  message = "Hola! Me interesa conocer más sobre los cursos de Outliers Academy",
  className = ""
}: WhatsAppButtonProps) {
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 ${className}`}>
      <button
        onClick={handleClick}
        className={`
          group relative flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 
      ...
      >
        {/* WhatsApp Icon */}
        <svg 
          className="w-8 h-8 text-white transition-transform duration-200 group-hover:scale-105" 
          fill="currentColor" 
          viewBox="0 0 24 24"
        >
