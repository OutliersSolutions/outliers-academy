  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 ${className}`}>
      ...
      <button
        onClick={handleClick}
        className={`
          w-16 h-16 bg-gradient-to-br from-[#25D366] to-[#20ba5a] hover:from-[#20ba5a] hover:to-[#1da851]
      ...
      {/* Pulse effect ring */}
      <div className="absolute inset-0 rounded-full bg-[#25D366]/30 animate-ping pointer-events-none"></div>
    </div>
  );
}